...
public class IndicatorResponseTest {
    ...
    public void testSimpleIndicatorResponse() throws IOException{
        ...
        SimpleIndicatorResponse response2 = BOPResponse.of(adapter.fromJson(errorMessage));
        SimpleIndicatorResponse response3 = TRANGEResponse.of(adapter.fromJson(errorMessage));
        SimpleIndicatorResponse response4 = ADResponse.of(adapter.fromJson(errorMessage));
        SimpleIndicatorResponse response5 = OBVResponse.of(adapter.fromJson(errorMessage));
        assertNotNull(response2.getErrorMessage());
        assertNotNull(response3.getErrorMessage());
        assertNotNull(response4.getErrorMessage());
        assertNotNull(response5.getErrorMessage());
